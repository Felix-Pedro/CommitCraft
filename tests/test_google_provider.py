...
# Import providers after verifying they are available (they are in src)
...
class TestOpenAICompatibleProviderGemini:
    def test_calculate_usage_uses_count_tokens_config_for_gemini(self, mock_google_modules):
